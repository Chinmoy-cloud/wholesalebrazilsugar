...
<div class="container-fluid py-5 mt-5">
    <div class="container py-5">
                ...
                <div class="row g-4">
                    <div class="col-lg-6">
                        <div class="border rounded">
                            <a href="#">
                                <?php if(file_exists($details->logo)){ ?>
                                  <img src="<?php echo base_url().$details->logo; ?>" class="img-fluid rounded" alt="Image">
                                <?php }else{ ?>
                                  <img src="<?php echo base_url();?>assets/admin/img/no-image.jpg" class="img-fluid rounded" alt="Image">   
                                <?php } ?>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <h4 class="fw-bold mb-3"><?php echo $details->title; ?></h4>
                        ...
                        <p class="mb-4"><?php echo $details->short_description; ?></p>
                        <a href="javascript:void(0)" class="btn border border-secondary rounded-pill px-4 py-2 mb-4 text-primary" onclick="getEnqueryModal(<?php echo $details->id; ?>)"><i class="fa fa-comments me-2 text-primary"></i> Enquiry</a>
                    </div>
                    <div class="col-lg-12">
                        <nav>
        ...
        <?php 
        $getRelatedProduct = getRelatedProduct($details->alias); 
        ?>
        <h1 class="fw-bold mb-0">Related products</h1>
        <div class="vesitable">
            <div class="owl-carousel vegetable-carousel justify-content-center">
               <?php
                if ($getRelatedProduct && count($getRelatedProduct) > 0) {
                    foreach ($getRelatedProduct as $key2 => $val) {
                ?>
